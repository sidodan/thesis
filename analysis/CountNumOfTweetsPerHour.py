...
# In case you wish to change the time aggregation, please comment out line 43 for hourly analysis, and line 41 for daily analysis
import os
import sys
import unicodedata
import json
...
OUTPUT_FOLDER_PATH = "output/NumOfTweetsPerDay"
