...
INPUT_FOLDER_PATH = "../graphs/data/Users"
OUTPUT_FOLDER_PATH = "../subgraphs/data/Users"
SEED_FILE_PATH = "../input/hashtags/user_files/orig/seeds.txt"
...
def spark_initiator():
	...
	conf = SparkConf().setAppName("UsersSubGraph")
